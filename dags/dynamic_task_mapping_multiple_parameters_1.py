...
def dynamic_task_mapping_multiple_parameters_1():
    ### 1) Use .expand to map over several kwargs to create a cross-product
    PythonOperator.partial(task_id="cross_product_calculations").expand(
        python_callable=[add_19, subtract_23], op_args=[[1], [2], [3]]
    )
...
dynamic_task_mapping_multiple_parameters_1()
